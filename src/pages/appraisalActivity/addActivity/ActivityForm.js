    ...
    <>
      ...
      <Row>
        <Col>
          <Card>
            <Card.Header>
              <h5 className="text-center fw-semibold label">
                    ...
                    <div className="container">
                      <div className="row">
                        ...
                        <div className="col-sm-6 mb-3">
                          <BootstrapForm.Group>
                            <BootstrapForm.Label htmlFor="period">
                        ...
                        <div className="col-sm-6 mb-3">
                          <BootstrapForm.Group>
                            <BootstrapForm.Label htmlFor="perspective">
                        ...
                        <div className="col-sm-6 mb-3">
                          <BootstrapForm.Group>
                            <BootstrapForm.Label htmlFor="ssMartaObjectives">
                              SsMarta Objectives{" "}
                        ...
                        <div className="col-sm-6 mb-3">
                          <BootstrapForm.Group>
                            <BootstrapForm.Label htmlFor="initiative">
                              Initiative <span className="text-danger">*</span>
                            </BootstrapForm.Label>
                        ...
                        <div className="col-sm-6 mb-3">
                          <BootstrapForm.Group>
                            <BootstrapForm.Label htmlFor="measurableActivities">
                              Measurable Activity{" "}
                              <span className="text-danger">*</span>
                            </BootstrapForm.Label>
                            <Field
                            ...
                            >
                              <option
                                key="default-measurable-activity"
                                value=""
                              >
                                Select Activity
                              </option>
                              {measurableActivityOptions &&
                                measurableActivityOptions.map((option) => (
                                  <option
                                    key={option.itemId}
                                    value={option.itemId}
                                  >
                        ...
                        <div className="col-sm-6 mb-3">
                          <BootstrapForm.Group>
                            <BootstrapForm.Label htmlFor="date">
